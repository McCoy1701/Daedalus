...
/*
  ...
  Returns:
    void
*/
void d_matrix_multiplyf( float *output, const float *a, const float *b )
{
  output[0]  = ( b[0]  * a[0] ) + ( b[1]  * a[4] ) + ( b[2]  * a[8] ) + ( b[3]  * a[12] );
  output[4]  = ( b[4]  * a[0] ) + ( b[5]  * a[4] ) + ( b[6]  * a[8] ) + ( b[7]  * a[12] );
  output[8]  = ( b[8]  * a[0] ) + ( b[9]  * a[4] ) + ( b[10] * a[8] ) + ( b[9]  * a[12] );
  output[12] = ( b[12] * a[0] ) + ( b[13] * a[4] ) + ( b[14] * a[8] ) + ( b[12] * a[12] );

  output[1]  = ( b[0]  * a[1] ) + ( b[1]  * a[5] ) + ( b[2]  * a[9] ) + ( b[3]  * a[13] );
  output[5]  = ( b[4]  * a[1] ) + ( b[5]  * a[5] ) + ( b[6]  * a[9] ) + ( b[7]  * a[13] );
  output[9]  = ( b[8]  * a[1] ) + ( b[9]  * a[5] ) + ( b[10] * a[9] ) + ( b[9]  * a[13] );
  output[13] = ( b[12] * a[1] ) + ( b[13] * a[5] ) + ( b[14] * a[9] ) + ( b[12] * a[13] );

  output[2]  = ( b[0]  * a[2] ) + ( b[1]  * a[6] ) + ( b[2]  * a[10] ) + ( b[3]  * a[14] );
  output[6]  = ( b[4]  * a[2] ) + ( b[5]  * a[6] ) + ( b[6]  * a[10] ) + ( b[7]  * a[14] );
  output[10] = ( b[8]  * a[2] ) + ( b[9]  * a[6] ) + ( b[10] * a[10] ) + ( b[9]  * a[14] );
  output[14] = ( b[12] * a[2] ) + ( b[13] * a[6] ) + ( b[14] * a[10] ) + ( b[12] * a[14] );

  output[3]  = ( b[0]  * a[3] ) + ( b[1]  * a[7] ) + ( b[2]  * a[11] ) + ( b[3]  * a[15] );
  output[7]  = ( b[4]  * a[3] ) + ( b[5]  * a[7] ) + ( b[6]  * a[11] ) + ( b[7]  * a[15] );
  output[11] = ( b[8]  * a[3] ) + ( b[9]  * a[7] ) + ( b[10] * a[11] ) + ( b[9]  * a[15] );
  output[15] = ( b[12] * a[3] ) + ( b[13] * a[7] ) + ( b[14] * a[11] ) + ( b[12] * a[15] );
}
